...
public class Coin extends CollectableAreaEntity {
    ...
    public Coin(Area area, Orientation orientation, DiscreteCoordinates position) {
        ...
        tab[0] = new RPGSprite("zelda/coin", 1, 1, this, new RegionOfInterest(0, 0, 16, 16));
        tab[1] = new RPGSprite("zelda/coin", 1, 1, this, new RegionOfInterest(16, 0, 16, 16));
        tab[2] = new RPGSprite("zelda/coin", 1, 1, this, new RegionOfInterest(32, 0, 16, 16));
        tab[3] = new RPGSprite("zelda/coin", 1, 1, this, new RegionOfInterest(48, 0, 16, 16));
        coin = new Animation(4, tab, true);
    }
    ...
    /**
     * Removes the coin from the area
     *
     */
    public void collect(){

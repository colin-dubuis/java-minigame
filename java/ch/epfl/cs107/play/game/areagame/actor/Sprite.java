...
public class Sprite extends ImageGraphics {
    ...
    public Sprite(String name, float width, float height, Positionable parent, RegionOfInterest roi, float depth) {
        super(ResourcePath.getSprite(name), width, height, roi, Vector.ZERO, 1.0f, depth);
        setParent(parent);
    }
